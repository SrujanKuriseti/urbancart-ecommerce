      ...
      <div style={styles.container}>
        ...
        <div style={styles.linksGrid}>
          ...
          <div style={styles.column}>
            <h3 style={styles.columnTitle}>About</h3>
          ...
          {/* Column 3 - FAQ */}
          <div style={styles.column}>
            <h3 style={styles.columnTitle}>FAQ</h3>
            <ul style={styles.linkList}>
              <li><a href="#" style={styles.link}>Payment Methods</a></li>
              <li><a href="#" style={styles.link}>Delivery Times</a></li>
        ...
        {/* Middle Section - Browse Products Button */}
        ...
        <div style={styles.bottomSection}>
          ...
          <div style={styles.copyright}>
            UrbanCart &copy; {new Date().getFullYear()}
          </div>
        </div>
      </div>
    </footer>
